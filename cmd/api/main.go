...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "22c2475a56b4c3", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "7971377a337661", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Dana <okshieva@gmail.com>", "SMTP sender")
